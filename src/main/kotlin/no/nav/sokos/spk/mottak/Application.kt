...
import no.nav.sokos.spk.mottak.config.DatabaseConfig.postgresDataSource
...
private fun Application.module() {
    ...
    Flyway
        .configure()
        .dataSource(postgresDataSource(role = PropertiesConfig.PostgresProperties().adminUser))
        .load()
        .migrate()
