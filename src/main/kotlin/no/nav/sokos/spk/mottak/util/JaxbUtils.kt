...
object JaxbUtils {
    ...
    private val jaxbContextTrekk = JAXBContext.newInstance(AndreTrekk::class.java)
    ...
    fun marshallTrekk(trekk: AndreTrekk): String {
        val marshaller =
    ...
    fun unmarshallTrekk(trekkXml: String): AndreTrekk {
        return jaxbContextTrekk.createUnmarshaller().unmarshal(StringReader(trekkXml)) as AndreTrekk
    }
