...
object MQConfig {
    fun connectionFactory(properties: PropertiesConfig.MQProperties): ConnectionFactory {
        return JmsFactoryFactory.getInstance(CommonConstants.WMQ_PROVIDER).createConnectionFactory().apply {
            ...
            setStringProperty(CommonConstants.WMQ_QUEUE_MANAGER, properties.mqQueueManager)
            setStringProperty(CommonConstants.WMQ_HOST_NAME, properties.mqHostname)
            setStringProperty(CommonConstants.WMQ_APPLICATIONNAME, PropertiesConfig.Configuration().naisAppName)
            setIntProperty(CommonConstants.WMQ_PORT, properties.mqPort)
            ...
            setStringProperty(CommonConstants.USERID, properties.serviceuserUsername)
            setStringProperty(CommonConstants.PASSWORD, properties.serviceuserPassword)
        }
    }
}
