...
object TrekkConverter {
    fun opprettTrekkMelding(it: Transaksjon) = Dokument(innrapporteringTrekk = opprettTrekk(it))
    ...
    private fun opprettTrekk(transaksjon: Transaksjon) =
        InnrapporteringTrekk(
            ...
            debitorId = transaksjon.fnr,
            kodeTrekktype = transaksjon.trekkType!!,
            kodeTrekkAlternativ = transaksjon.trekkAlternativ!!,
            periode =
                Periode(
                    transaksjon.datoFom!!.format(formatter),
                    transaksjon.datoTom!!.format(formatter),
