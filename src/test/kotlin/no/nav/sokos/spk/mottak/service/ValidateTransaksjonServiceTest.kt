...
class ValidateTransaksjonServiceTest : BehaviorSpec({
    ...
    Given("det finnes en inn-transaksjon som er dublett med en eksisterende avvist transaksjon") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som er dublett med en eksisterende transaksjon") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som har ugyldig fnr") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon med beløpstype 01 som har ugyldig DatoFom") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon med beløpstype 01 som har ugyldig DatoTom") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon med beløpstype 03 som har ugyldig DatoFom") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon med beløpstype 03 som har ugyldig DatoTom") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som har ugyldig beløpstype") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som har ugyldig art") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som har ugyldig anviserdato") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som har ugyldig beløp") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon som har ugyldig kombinasjon av art og beløpstype") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon med et fnr som ikke eksisterer i T_TRANSAKSJON") {
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
                    "insert into T_INN_TRANSAKSJON (FIL_INFO_ID, K_TRANSAKSJON_S, FNR_FK, BELOPSTYPE, ART, AVSENDER, UTBETALES_TIL, DATO_FOM_STR, DATO_TOM_STR, DATO_ANVISER_STR, BELOP_STR, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, BELOP, BEHANDLET, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, GRAD, GRAD_STR) " +
    ...
    Given("det finnes en inn-transaksjon med et eksisterende fnr som har blitt endret i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            personId = session.updateAndReturnGeneratedKey(
                queryOf(
                    "insert into T_PERSON (FNR_FK, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON) " +
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '01', 'BPE', 'SPK', '66043800999', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med et eksisterende fnr som historisk har hatt en annen verdi i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '01', 'BPE', 'SPK', '66043800999', null, null, null, '2023-04-01', '2023-04-30', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '01', 'BPE', 'SPK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med beløpstype utbetaling hvor det eksisterer bare beløpstype trekk for samme person i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '03', 'TNS', 'SPK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med beløpstype utbetaling hvor det eksisterer samme beløpstype for samme person i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '02', 'ETT', 'SPK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med et eksisterende fnr men for en annen anviser i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '01', 'ETT', 'OK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med eksisterende fnr og en art som tilhører samme fagområde som eksisterende art for personen i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (98, null, 20000816, '00', " + personId + ", '01', 'ETT', 'SPK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99, null, 20000816, '00', " + personId + ", '02', 'BPE', 'SPK', '66043800214', null, null, null, '2023-07-01', '2023-07-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '6666666666', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med eksisterende fnr og en art som tilhører et annet fagområde enn eksisterende art for personen i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (98000000, null, 20000816, '00', " + personId + ", '02', 'UFE', 'SPK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99000000, null, 20000816, '00', " + personId + ", '01', 'UFT', 'SPK', '66043800214', null, null, null, '2023-07-01', '2023-07-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '6666666666', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med eksisterende fnr og en art som tilhører et annet fagområde enn eksisterende art for personen i T_TRANSAKSJON men med en annen anviser") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (98000000, null, 20000816, '00', " + personId + ", '02', 'UFE', 'OK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99000000, null, 20000816, '00', " + personId + ", '01', 'UFT', 'OK', '66043800214', null, null, null, '2023-07-01', '2023-07-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '6666666666', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
    ...
    Given("det finnes en inn-transaksjon med eksisterende fnr og en art som er ulik en historisk art som tilhører et annet fagområde for personen i T_TRANSAKSJON") {
        var personId: Long?
        Db2Listener.dataSource.transaction { session ->
            session.update(
                queryOf(
            ...
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (98000000, null, 20000816, '00', " + personId + ", '02', 'UFT', 'SPK', '66043800214', null, null, null, '2023-04-01', '2023-04-30', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '999999999', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
            session.update(
                queryOf(
                    "insert into T_TRANSAKSJON (TRANSAKSJON_ID, TRANS_TILSTAND_ID, FIL_INFO_ID, K_TRANSAKSJON_S, PERSON_ID, K_BELOP_T, K_ART, K_ANVISER, FNR_FK, UTBETALES_TIL, OS_ID_FK, OS_LINJE_ID_FK, DATO_FOM, DATO_TOM, DATO_ANVISER, DATO_PERSON_FOM, DATO_REAK_FOM, BELOP, REF_TRANS_ID, TEKSTKODE, RECTYPE, TRANS_EKS_ID_FK, K_TRANS_TOLKNING, SENDT_TIL_OPPDRAG, TREKKVEDTAK_ID_FK, FNR_ENDRET, MOT_ID, OS_STATUS, DATO_OPPRETTET, OPPRETTET_AV, DATO_ENDRET, ENDRET_AV, VERSJON, K_TREKKANSVAR, K_TRANS_TILST_T, GRAD) " +
                            "values (99000000, null, 20000816, '00', " + personId + ", '01', 'RNT', 'SPK', '66043800214', null, null, null, '2023-05-01', '2023-05-31', '2023-04-25', '1900-01-01', '1900-01-01', 51700, null, null, '02', '6666666666', 'NY', '0', null, '0', '1', null, '2024-04-24 08:45:08.998930','sokos-spk-mottak', '2024-04-24 08:45:08.999190', 'sokos-spk-mottak', 1, '4819', 'OPR', null)"
                )
            )
        }
        Db2Listener.innTransaksjonRepository.getByBehandletWithPersonId().size shouldBe 1
